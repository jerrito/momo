...
void initState(){
  ...
  Widget build(BuildContext context) {
    ...
    children:[
      Center(child:Text("Recipient",style:TextStyle(fontWeight: FontWeight.bold,fontSize:26))),
      SizedBox(height: 20,),
      ...
      Container(
        ...
        child: RadioListTile(value: "user", activeColor: Colors.black,groupValue: user,tileColor: Colors.deepOrange,
            onChanged: (value){other=false; setState(() {
              user = value.toString();
            });},
          title:Text("Self(0${userProvider?.appUser?.number?.substring(4)})") ,
        ),
      ),
     // Text("Self(0240845898)"),
      ...
      Container(
        ...
        child: RadioListTile(value: "others", activeColor: Colors.black,groupValue: user,tileColor: Colors.deepOrange,
          onChanged: (value){other=true; setState(() {
            user = value.toString();
          });},
          title:Text("others") ,
        ),
